...
def trace_distance(rho, sigma):
    """Calculate the trace distance between two density matrices rho and sigma."""
    diff = rho - sigma
...
for a range of energy-like parameters ω.
...
# Save to TXT instead of CSV
np.savetxt("optimal_distance_data.txt", data_to_save,
           fmt="%.6f", header="omega p_opt optimal_distance", comments="")
