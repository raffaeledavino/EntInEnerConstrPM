...
def findMeasurement(dim, dimM, states,nonEABellValue):
    ...
    for _ in range(n_restarts):
        ...
        try:
            while newPguess - firstPguess > error:# and iter_count < max_iter:
                ...
                newPguess, measurement = findMeasurement(dim, dimM, states, nonEABellValue)
                iter_count += 1
...
if __name__ == "__main__":
    ...
    with open(output_file, 'w') as f:
        ...
        for w in energyrange:
            ...
            nonEABellValue, _ = computeMaxIneqViolation(w0Avg, w1Avg, ineq)
                ...
                while qPguess < cPguess + tol:
                    ...
                    try:
                        ...
                        while newPguess - firstPguess > error:
                            firstPguess, states = findStates(
                                dim, dimM, w0Avg, w1Avg, measurement, ground, nonEABellValue
                            )
                            newPguess, measurement = findMeasurement(
